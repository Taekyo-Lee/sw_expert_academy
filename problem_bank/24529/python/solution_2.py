...
for test_case in range(1, T + 1):
    ...
    # Forward DP with dp_history for backtracking
    dp_history = []
    ...
    # Find best sum in dp[M] closest to target
    final = dp[M]
    best_sum_F = -1
    ...
    # Step 3: Backtrack to find which values belong to the smaller-sum group
    ...
    F.sort()
    # Sort L descending (for row 2, columns 1..N-1) -- MOUNTAIN ARRANGEMENT
    L.sort(reverse=True)
